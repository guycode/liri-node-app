...
function start() {
    ...
    if (input1 === "my-tweets") {
        ...
        request("http://www.omdbapi.com/?i=tt3896198&apikey=39f055b2" + input2 + "&y=&plot=short&r=json&tomatoes=true", function(error, response, body) {
